...
// ---------------------------------------------------------------------------
// EU TX SHAPES SIM (Pack 22.0) — block-style EU flow
// ---------------------------------------------------------------------------
//
// Purpose:
...
//   2. Sets up a vault for OWNER and funds it.
//   3. Applies two MINT_EU txs in sequence.
...
export function main(): void {
  console.log("=== EU TX SHAPES SIM (Pack 22.0) ===");
  ...
  console.log("\n--- FINAL EU REGISTRY ---");
  const certA = getEuCertificate(ledger3.eu, mintTxA.euId);
  const certB = getEuCertificate(ledger3.eu, mintTxB.euId);

  console.log("certA:", certA);
  console.log("certB:", certB);

  console.log("\n--- Helper predicates ---");
  console.log("isEuActive(A):   ", isEuActive(ledger3.eu, mintTxA.euId));
  console.log("isEuRedeemed(A): ", isEuRedeemed(ledger3.eu, mintTxA.euId));
  console.log("isEuActive(B):   ", isEuActive(ledger3.eu, mintTxB.euId));
  console.log("isEuRedeemed(B): ", isEuRedeemed(ledger3.eu, mintTxB.euId));
