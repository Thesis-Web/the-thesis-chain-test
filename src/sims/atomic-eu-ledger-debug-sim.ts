...
// ---------------------------------------------------------------------------
// Pack 53 — EU Atomic Ledger Debug Sim
// ---------------------------------------------------------------------------
//
...
import { createEmptyChainState } from "../ledger/state-fixtures";
import { createEmptyEuRegistry, type EuCertificate } from "../ledger/eu";
import {
  assertEuLedgerAtomicFromState
} from "../ledger/atomic-eu-ledger-debug";
import {
  type EuAtomicPolicy
...
async function main(): Promise<void> {
  // Policy examples mirroring Pack 52 sims
  const defaultPolicy: EuAtomicPolicy = {
    atomicUnit: 1n
  };

  const cappedPolicy: EuAtomicPolicy = {
    atomicUnit: 1n,
    maxSupply: 100n
  };
